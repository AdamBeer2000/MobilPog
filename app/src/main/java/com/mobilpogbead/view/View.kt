...
class View(private val model:Model,private var pointCounter:TextView,private var lifeCounter:TextView,private var deathAnim: Bitmap, private var context: Context)
{
